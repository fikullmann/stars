...
data class SatHistorically(val tp1: TP, val tp2: TP, val alphas: MutableList<SatProof>) : SatProof() {
...
data class SatSince(val beta: SatProof, val alphas: MutableList<SatProof> = mutableListOf()) : SatProof() {
...
data class SatExists<T: EntityType<*, *, *, *, *>>(val ref: Ref<T>, val witness: RefId?, val alpha: SatProof) : SatProof() {
    override fun size(): Int = 1 + alpha.size()
    override fun at(): TP = alpha.at()
}
data class SatForall<T: EntityType<*, *, *, *, *>>(val ref: Ref<T>, val part: List<Pair<RefId?, SatProof>>) : SatProof() {
    override fun size(): Int = 1 + part.fold(0) { acc, (_, proof) ->
        acc + proof.size()
    }
    override fun at(): TP = part.first().second.at()
}

data class SatPastMinPrev(val tp1: TP, val tp2: TP, val fraction: Double, val sAlphas: MutableList<Proof>) : SatProof() {
...
data class SatMinPrev(val tp1: TP, val tp2: TP, val fraction: Double, val sAlphas: MutableList<Proof>) : SatProof() {
    override fun size(): Int = 1 + sAlphas.sumOf { it.size() }
    override fun at(): TP = tp1
}
...
data class SatPastMaxPrev(val tp1: TP, val tp2: TP, val fraction: Double, val sAlphas: MutableList<Proof>) : SatProof() {
    override fun size(): Int = 1 + sAlphas.sumOf { it.size() }
    override fun at(): TP = tp1
}
data class SatMaxPrev(val tp1: TP, val tp2: TP, val fraction: Double, val sAlphas: MutableList<Proof>) : SatProof() {
    override fun size(): Int = 1 + sAlphas.sumOf { it.size() }
    override fun at(): TP = tp1
}
...
data class VSince(var tp: TP, val vAlpha: Proof, val vBetas: MutableList<Proof>) : ViolationProof() {
...
data class VUntil(var tp: TP, val vAlpha: Proof, val vBetas: MutableList<Proof>) : ViolationProof() {
    override fun size(): Int = 1 + vAlpha.size() + vBetas.sumOf { it.size() }
    override fun at(): TP = tp
}
...
data class VExists<T: EntityType<*, *, *, *, *>>(val ref: Ref<T>, val part: List<Pair<RefId?, ViolationProof>>) : ViolationProof() {
    override fun size(): Int = 1 + part.fold(0) { acc, (_, proof) ->
        acc + proof.size()
    }
    override fun at(): TP = part.first().second.at()
...
data class VForall<T: EntityType<*, *, *, *, *>>(val ref: Ref<T>, val witness: RefId?, val alpha: ViolationProof) : ViolationProof() {
    override fun size(): Int = 1 + alpha.size()
    override fun at(): TP = alpha.at()
}

data class VPastMinPrev(val tp1: TP, val tp2: TP, val fraction: Double, val vAlphas: MutableList<ViolationProof>) : ViolationProof() {
    override fun size(): Int = 1 + vAlphas.sumOf { it.size() }
    override fun at(): TP = tp1
}
data class VMinPrev(val tp1: TP, val tp2: TP, val fraction: Double, val vAlphas: MutableList<ViolationProof>) : ViolationProof() {
    override fun size(): Int = 1 + vAlphas.sumOf { it.size() }
    override fun at(): TP = tp1
}
data class VPastMaxPrev(val tp1: TP, val tp2: TP, val fraction: Double, val vAlphas: MutableList<ViolationProof>) : ViolationProof() {
    override fun size(): Int = 1 + vAlphas.sumOf { it.size() }
    override fun at(): TP = tp1
}
...
data class VMaxPrev(val tp1: TP, val tp2: TP, val fraction: Double, val vAlphas: MutableList<ViolationProof>) : ViolationProof() {
    override fun size(): Int = 1 + vAlphas.sumOf { it.size() }
    override fun at(): TP = tp1
}
