 ...
 * Timestamp
 */
data class TS(val i: Double): Comparable<TS> {
 ...
 * Timepoint
 */
data class TP(val i: Int): Comparable<TP> {
...
data class BoundedInterval(override val startVal: Double = 0.0, val endVal: Double = 0.0): Interval() {
