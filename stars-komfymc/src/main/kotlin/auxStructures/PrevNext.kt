...
class PrevNext {
    companion object {
        ...
        private fun prevNextAux(
            ...
            val prevNextProofs: MutableList<Proof> = when {
                p is SatProof && interval.contains(t) -> mutableListOf(if (prev) SatPrev(p) else SatNext(p))
            ...
            ps.add(0, prevNextProofs.reduce { acc, newProof ->
